...
%     \centering
%     \includegraphics[width=0.9\linewidth]{resources/5_experiment_and_results/frequency_before_pandemic.png}
%       \caption{Participants' frequency of accessing the campus before pandemic}
%   \end{minipage}\hfill
%   \begin{minipage}{0.48\textwidth}
%     \centering
%     \includegraphics[width=0.9\linewidth]{resources/5_experiment_and_results/frequency_after_pandemic.png}
