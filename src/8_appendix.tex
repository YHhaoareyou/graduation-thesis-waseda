\chapter{Questions about motivation adopted from SIMS}
...
\begin{table}[h]
    \begin{center}
      \caption{Free responses of changes in image of the campus by participation in Co-creation}\label{table:12}
      \begin{tabular}{L{\textwidth}}
        \hline
        \rowcolor{lightgray}
          \multicolumn{1}{c}{Free responses} \\
...
\begin{table}[h]
    \begin{center}
      \caption{Free responses of changes in image of the campus by interaction among users}\label{table:13}
      \begin{tabular}{L{\textwidth}}
        \hline
        \rowcolor{lightgray}
          \multicolumn{1}{c}{Free responses} \\
...
\begin{table}[h]
  \begin{center}
    \caption{Example responses of preference between prototype at campus or situation at home by participation in Co-creation}\label{table:16}
    \begin{tabular}{C{2.5cm} | L{10cm}}
      \hline
      \rowcolor{lightgray}
      \multicolumn{1}{C{2.5cm}}{Preference} & \multicolumn{1}{c}{Example responses} \\
